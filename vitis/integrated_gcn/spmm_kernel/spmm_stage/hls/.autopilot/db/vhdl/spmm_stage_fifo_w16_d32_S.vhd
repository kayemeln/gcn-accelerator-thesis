...
entity spmm_stage_fifo_w16_d32_S is 
    generic (
...
architecture rtl of spmm_stage_fifo_w16_d32_S is
...
------------------------Component----------------------
    component spmm_stage_fifo_w16_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_spmm_stage_fifo_w16_d32_S_ShiftReg : spmm_stage_fifo_w16_d32_S_ShiftReg
    generic map (
...
entity spmm_stage_fifo_w16_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 16;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end spmm_stage_fifo_w16_d32_S_ShiftReg;

architecture rtl of spmm_stage_fifo_w16_d32_S_ShiftReg is
