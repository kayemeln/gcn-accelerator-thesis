...
set C_modelArgList {
	...
	{ val_fifo int 16 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "H_temp","offset": { "type": "dynamic","port_name": "H_temp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "val_fifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem3_0_WDATA sc_out sc_lv 512 signal 0 } 
	{ m_axi_gmem3_0_WSTRB sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_gmem3_0_RDATA sc_in sc_lv 512 signal 0 } 
	...
	{ val_fifo_dout sc_in sc_lv 16 signal 4 } 
	...
	{ result_fifo_din sc_out sc_lv 16 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "val_fifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "val_fifo", "role": "dout" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "259969", "Max" : "10209161"}
	, {"Name" : "Interval", "Min" : "259969", "Max" : "10209161"}
]}
...
set Spec2ImplPortList { 
	...
	val_fifo { ap_fifo {  { val_fifo_dout fifo_data_out 0 16 }  { val_fifo_empty_n fifo_status_empty 0 1 }  { val_fifo_read fifo_data_in 1 1 }  { val_fifo_num_data_valid fifo_update 0 9 }  { val_fifo_fifo_cap fifo_data 0 9 } } }
