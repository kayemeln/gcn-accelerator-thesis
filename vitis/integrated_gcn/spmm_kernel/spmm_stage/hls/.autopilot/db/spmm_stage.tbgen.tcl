...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "row_length","offset": { "type": "dynamic","port_name": "row_length","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "H_temp","offset": { "type": "dynamic","port_name": "H_temp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem4", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "H_out","offset": { "type": "dynamic","port_name": "H_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "row_length", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
...
set portList { 
	...
	{ nnz_total sc_in sc_lv 32 signal 9 } 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"row_length","role":"data","value":"16"},{"name":"colind","role":"data","value":"28"},{"name":"values","role":"data","value":"40"},{"name":"H_temp","role":"data","value":"52"},{"name":"H_out","role":"data","value":"64"}] },
...
set ArgLastReadFirstWriteLatency {
	spmm_stage {
		...
		nnz_total {Type I LastRead 1 FirstWrite -1}
		H_out {Type I LastRead 0 FirstWrite -1}}
	entry_proc {
		H_out {Type I LastRead 0 FirstWrite -1}
		H_out_c {Type O LastRead -1 FirstWrite 0}}
	spmm_load_csr {
		gmem0 {Type I LastRead 1 FirstWrite -1}
	...
	spmm_compute_Pipeline_SPMM_LOAD_H {
		...
		sext_ln62_1 {Type I LastRead 0 FirstWrite -1}
