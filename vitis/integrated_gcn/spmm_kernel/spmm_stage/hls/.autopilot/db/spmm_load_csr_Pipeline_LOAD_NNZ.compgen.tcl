...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { val_fifo_din { O 16 vector } val_fifo_full_n { I 1 bit } val_fifo_write { O 1 bit } val_fifo_num_data_valid { I 9 vector } val_fifo_fifo_cap { I 9 vector } } \
} "
}
