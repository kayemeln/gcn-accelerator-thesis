...
set cdfgNum 13
set C_modelName {spmm_store}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem4 int 512 regular {axi_master 1}  }
	{ H_out int 64 regular {fifo 0}  }
	{ result_fifo int 16 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "gmem4", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "H_out","offset": { "type": "dynamic","port_name": "H_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "H_out", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "result_fifo", "interface" : "fifo", "bitwidth" : 16, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ H_out_dout sc_in sc_lv 64 signal 1 } 
	{ H_out_empty_n sc_in sc_logic 1 signal 1 } 
	{ H_out_read sc_out sc_logic 1 signal 1 } 
	{ H_out_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ H_out_fifo_cap sc_in sc_lv 3 signal 1 } 
	{ result_fifo_dout sc_in sc_lv 16 signal 2 } 
	{ result_fifo_empty_n sc_in sc_logic 1 signal 2 } 
	{ result_fifo_read sc_out sc_logic 1 signal 2 } 
	{ result_fifo_num_data_valid sc_in sc_lv 6 signal 2 } 
	{ result_fifo_fifo_cap sc_in sc_lv 6 signal 2 } 
	{ m_axi_gmem4_0_AWVALID sc_out sc_logic 1 signal 0 } 
	{ m_axi_gmem4_0_AWREADY sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem4_0_AWADDR sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_gmem4_0_WDATA sc_out sc_lv 512 signal 0 } 
	{ m_axi_gmem4_0_WSTRB sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_gmem4_0_ARADDR sc_out sc_lv 64 signal 0 } 
	...
	{ m_axi_gmem4_0_RDATA sc_in sc_lv 512 signal 0 } 
	{ m_axi_gmem4_0_RLAST sc_in sc_logic 1 signal 0 } 
	{ m_axi_gmem4_0_RID sc_in sc_lv 1 signal 0 } 
	{ m_axi_gmem4_0_RFIFONUM sc_in sc_lv 9 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "H_out_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "H_out", "role": "dout" }} , 
 	{ "name": "H_out_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "H_out", "role": "empty_n" }} , 
 	{ "name": "H_out_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "H_out", "role": "read" }} , 
 	{ "name": "H_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "H_out", "role": "num_data_valid" }} , 
 	{ "name": "H_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "H_out", "role": "fifo_cap" }} , 
 	{ "name": "result_fifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "result_fifo", "role": "dout" }} , 
 	{ "name": "result_fifo_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "result_fifo", "role": "empty_n" }} , 
 	{ "name": "result_fifo_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "result_fifo", "role": "read" }} , 
 	{ "name": "result_fifo_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "result_fifo", "role": "num_data_valid" }} , 
 	{ "name": "result_fifo_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "result_fifo", "role": "fifo_cap" }} , 
...
set ArgLastReadFirstWriteLatency {
	spmm_store {
		...
		H_out {Type I LastRead 1 FirstWrite -1}
		result_fifo {Type I LastRead 3 FirstWrite -1}}}

set hasDtUnsupportedChannel 0

set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "173322", "Max" : "173322"}
	, {"Name" : "Interval", "Min" : "173312", "Max" : "173312"}
]}
...
set Spec2ImplPortList { 
	...
	H_out { ap_fifo {  { H_out_dout fifo_data_out 0 64 }  { H_out_empty_n fifo_status_empty 0 1 }  { H_out_read fifo_data_in 1 1 }  { H_out_num_data_valid fifo_update 0 3 }  { H_out_fifo_cap fifo_data 0 3 } } }
	result_fifo { ap_fifo {  { result_fifo_dout fifo_data_out 0 16 }  { result_fifo_empty_n fifo_status_empty 0 1 }  { result_fifo_read fifo_data_in 1 1 }  { result_fifo_num_data_valid fifo_update 0 6 }  { result_fifo_fifo_cap fifo_data 0 6 } } }
}
