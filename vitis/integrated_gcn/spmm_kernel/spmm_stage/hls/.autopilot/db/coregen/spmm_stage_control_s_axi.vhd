...
entity spmm_stage_control_s_axi is
generic (
...
end entity spmm_stage_control_s_axi;
...
architecture behave of spmm_stage_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_ROW_LENGTH_DATA_0 : INTEGER := 16#10#;
    constant ADDR_ROW_LENGTH_DATA_1 : INTEGER := 16#14#;
    constant ADDR_ROW_LENGTH_CTRL   : INTEGER := 16#18#;
