...
entity spmm_stage_fifo_w32_d16_S is 
    generic (
...
architecture rtl of spmm_stage_fifo_w32_d16_S is
...
------------------------Component----------------------
    component spmm_stage_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_spmm_stage_fifo_w32_d16_S_ShiftReg : spmm_stage_fifo_w32_d16_S_ShiftReg
    generic map (
...
entity spmm_stage_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end spmm_stage_fifo_w32_d16_S_ShiftReg;

architecture rtl of spmm_stage_fifo_w32_d16_S_ShiftReg is
