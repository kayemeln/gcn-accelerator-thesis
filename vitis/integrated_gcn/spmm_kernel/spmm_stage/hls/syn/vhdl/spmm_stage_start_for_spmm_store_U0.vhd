...
entity spmm_stage_start_for_spmm_store_U0 is 
    generic (
...
architecture rtl of spmm_stage_start_for_spmm_store_U0 is
...
------------------------Component----------------------
    component spmm_stage_start_for_spmm_store_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_spmm_stage_start_for_spmm_store_U0_ShiftReg : spmm_stage_start_for_spmm_store_U0_ShiftReg
    generic map (
...
entity spmm_stage_start_for_spmm_store_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end spmm_stage_start_for_spmm_store_U0_ShiftReg;

architecture rtl of spmm_stage_start_for_spmm_store_U0_ShiftReg is
