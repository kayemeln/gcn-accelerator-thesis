...
module spmm_stage_spmm_load_csr_Pipeline_LOAD_NNZ (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [15:0] gmem2_addr_read_reg_185;
reg   [30:0] i_2_fu_64;
wire   [30:0] add_ln23_fu_136_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_2_load;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
reg    ap_block_pp0_stage0_01001_grp2;
wire   [31:0] zext_ln23_fu_126_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln23_fu_130_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln23_fu_130_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln23_fu_136_p2 = (ap_sig_allocacmp_i_2_load + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (col_fifo_full_n == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)));
end

always @ (*) begin
    ap_block_pp0_stage0_01001_grp2 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (val_fifo_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (m_axi_gmem2_0_RVALID == 1'b0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (val_fifo_full_n == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (col_fifo_full_n == 1'b0)))) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (((1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (m_axi_gmem2_0_RVALID == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (col_fifo_full_n == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp2 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (val_fifo_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (m_axi_gmem2_0_RVALID == 1'b0)));
end
...
always @ (*) begin
    ap_block_pp0_stage0_subdone_grp1 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg) & (col_fifo_full_n == 1'b0)) | ((m_axi_gmem1_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp1_done_reg)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone_grp2 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (val_fifo_full_n == 1'b0)) | ((ap_enable_reg_pp0_iter1 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone_grp2_done_reg) & (m_axi_gmem2_0_RVALID == 1'b0)));
end
...
assign col_fifo_din = gmem1_addr_read_reg_180;

assign icmp_ln23_fu_130_p2 = (($signed(zext_ln23_fu_126_p1) < $signed(nnz_total)) ? 1'b1 : 1'b0);
...
assign val_fifo_din = gmem2_addr_read_reg_185;

assign zext_ln23_fu_126_p1 = ap_sig_allocacmp_i_2_load;

endmodule //spmm_stage_spmm_load_csr_Pipeline_LOAD_NNZ
