set moduleName naive_spmm_stage
set isTopModule 1
...
set cdfgNum 6
set C_modelName {naive_spmm_stage}
...
set C_modelArgList {
	...
	{ gmem4 int 16 regular {axi_master 1}  }
	{ rowptr int 64 regular {axi_slave 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "rowptr","offset": { "type": "dynamic","port_name": "rowptr","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "colind","offset": { "type": "dynamic","port_name": "colind","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "values","offset": { "type": "dynamic","port_name": "values","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 16, "direction" : "READONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "H_temp","offset": { "type": "dynamic","port_name": "H_temp","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "gmem4", "interface" : "axi_master", "bitwidth" : 16, "direction" : "WRITEONLY", "id_num" : 1, "bitSlice":[ {"cElement": [{"cName": "H_out","offset": { "type": "dynamic","port_name": "H_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "rowptr", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":27}} , 
 	{ "Name" : "colind", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":28}, "offset_end" : {"in":39}} , 
 	{ "Name" : "values", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":40}, "offset_end" : {"in":51}} , 
 	{ "Name" : "H_temp", "interface" : "axi_slave", "bundle":"control","type":"ap_none","bitwidth" : 64, "direction" : "READONLY", "offset" : {"in":52}, "offset_end" : {"in":63}} , 
...
set NewPortList {[ 
	{ "name": "s_axi_control_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "control", "role": "AWADDR" },"address":[{"name":"rowptr","role":"data","value":"16"},{"name":"colind","role":"data","value":"28"},{"name":"values","role":"data","value":"40"},{"name":"H_temp","role":"data","value":"52"},{"name":"H_out","role":"data","value":"64"}] },
...
set ArgLastReadFirstWriteLatency {
	naive_spmm_stage {
		...
		gmem1 {Type I LastRead 28 FirstWrite -1}
		gmem2 {Type I LastRead 28 FirstWrite -1}
		gmem3 {Type I LastRead 74 FirstWrite -1}
		gmem4 {Type O LastRead 3 FirstWrite 2}
		rowptr {Type I LastRead 0 FirstWrite -1}
	...
	naive_spmm_stage_Pipeline_SPMM_WRITE {
		gmem4 {Type O LastRead -1 FirstWrite 2}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "677007", "Max" : "29701351"}
	, {"Name" : "Interval", "Min" : "677008", "Max" : "29701352"}
]}
