...
module naive_spmm_stage_naive_spmm_stage_Pipeline_SPMM_WRITE (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [9:0] m_axi_gmem4_0_RFIFONUM;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln41_fu_101_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        trunc_ln5_reg_160 <= {{acc_q0[25:10]}};
    end
end
...
always @ (*) begin
    if (((icmp_ln41_fu_101_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
assign acc_address0 = zext_ln41_fu_113_p1;

assign acc_ce0 = acc_ce0_local;

assign add_ln41_fu_107_p2 = (ap_sig_allocacmp_f_1 + 7'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_gmem4_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = ((m_axi_gmem4_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_gmem4_0_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign icmp_ln41_fu_101_p2 = ((ap_sig_allocacmp_f_1 == 7'd64) ? 1'b1 : 1'b0);
...
assign m_axi_gmem4_0_WDATA = trunc_ln5_reg_160;

assign m_axi_gmem4_0_WID = 1'd0;

assign m_axi_gmem4_0_WLAST = 1'b0;

assign m_axi_gmem4_0_WSTRB = 2'd3;

assign m_axi_gmem4_0_WUSER = 1'd0;

assign zext_ln41_fu_113_p1 = ap_sig_allocacmp_f_1;

endmodule //naive_spmm_stage_naive_spmm_stage_Pipeline_SPMM_WRITE
