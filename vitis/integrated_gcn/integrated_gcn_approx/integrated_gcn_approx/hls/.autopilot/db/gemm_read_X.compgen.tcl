...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_approx_mac_muladd_11ns_6ns_6ns_16_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
set InstName integrated_gcn_approx_flow_control_loop_pipe_U
set CompName integrated_gcn_approx_flow_control_loop_pipe
