...
extern "C" void integrated_gcn_approx(Byte<64>*, Byte<64>*, Byte<64>*, Byte<4>*, Byte<4>*, Byte<1>*, Byte<64>*, int, int, int, int, int, int, int, int);
extern "C" void apatb_integrated_gcn_approx_hw(volatile void * __xlx_apatb_param_X, volatile void * __xlx_apatb_param_W, volatile void * __xlx_apatb_param_H_temp, volatile void * __xlx_apatb_param_row_length, volatile void * __xlx_apatb_param_colind, volatile void * __xlx_apatb_param_values, int __xlx_apatb_param_nnz_total, volatile void * __xlx_apatb_param_H_out) {
using hls::sim::createStream;
  // Collect __xlx_X__tmp_vec
std::vector<Byte<64>> __xlx_X__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_X__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_X)[i]);
}
  int __xlx_size_param_X = 1;
  int __xlx_offset_param_X = 0;
  int __xlx_offset_byte_param_X = 0*64;
  // Collect __xlx_W__tmp_vec
std::vector<Byte<64>> __xlx_W__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_W__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_W)[i]);
}
  int __xlx_size_param_W = 1;
  int __xlx_offset_param_W = 0;
  int __xlx_offset_byte_param_W = 0*64;
...
std::vector<Byte<1>> __xlx_values__tmp_vec;
for (size_t i = 0; i < 1; ++i){
__xlx_values__tmp_vec.push_back(((Byte<1>*)__xlx_apatb_param_values)[i]);
}
  int __xlx_size_param_values = 1;
  int __xlx_offset_param_values = 0;
  int __xlx_offset_byte_param_values = 0*1;
...
__xlx_H_out__tmp_vec.push_back(((Byte<64>*)__xlx_apatb_param_H_out)[i]);
  ...
  // DUT call
  integrated_gcn_approx(__xlx_X__tmp_vec.data(), __xlx_W__tmp_vec.data(), __xlx_H_temp__tmp_vec.data(), __xlx_row_length__tmp_vec.data(), __xlx_colind__tmp_vec.data(), __xlx_values__tmp_vec.data(), __xlx_H_out__tmp_vec.data(), __xlx_offset_byte_param_X, __xlx_offset_byte_param_W, __xlx_offset_byte_param_H_temp, __xlx_offset_byte_param_row_length, __xlx_offset_byte_param_colind, __xlx_offset_byte_param_values, __xlx_apatb_param_nnz_total, __xlx_offset_byte_param_H_out);
// print __xlx_apatb_param_X
for (size_t i = 0; i < __xlx_size_param_X; ++i) {
((Byte<64>*)__xlx_apatb_param_X)[i] = __xlx_X__tmp_vec[__xlx_offset_param_X+i];
}
// print __xlx_apatb_param_W
for (size_t i = 0; i < __xlx_size_param_W; ++i) {
((Byte<64>*)__xlx_apatb_param_W)[i] = __xlx_W__tmp_vec[__xlx_offset_param_W+i];
}
...
((Byte<1>*)__xlx_apatb_param_values)[i] = __xlx_values__tmp_vec[__xlx_offset_param_values+i];
}
