set moduleName spmm_load_csr_Pipeline_LOAD_ROWS
set isTopModule 0
...
set cdfgNum 21
set C_modelName {spmm_load_csr_Pipeline_LOAD_ROWS}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ gmem3 int 32 regular {axi_master 0 stable }  }
	{ sext_ln202 int 62 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "row_length","offset": { "type": "dynamic","port_name": "row_length","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln202", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ row_fifo_din sc_out sc_lv 32 signal 2 } 
	{ row_fifo_full_n sc_in sc_logic 1 signal 2 } 
	{ row_fifo_write sc_out sc_logic 1 signal 2 } 
	{ row_fifo_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ row_fifo_fifo_cap sc_in sc_lv 5 signal 2 } 
	{ sext_ln202 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln202", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln202", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2711", "Max" : "2711"}
	, {"Name" : "Interval", "Min" : "2709", "Max" : "2709"}
]}
...
set Spec2ImplPortList { 
	...
	sext_ln202 { ap_stable {  { sext_ln202 in_data 0 62 } } }
