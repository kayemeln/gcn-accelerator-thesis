...
entity integrated_gcn_approx_fifo_w8_d32_S is 
    generic (
...
architecture rtl of integrated_gcn_approx_fifo_w8_d32_S is
...
------------------------Component----------------------
    component integrated_gcn_approx_fifo_w8_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_integrated_gcn_approx_fifo_w8_d32_S_ShiftReg : integrated_gcn_approx_fifo_w8_d32_S_ShiftReg
    generic map (
...
entity integrated_gcn_approx_fifo_w8_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 8;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end integrated_gcn_approx_fifo_w8_d32_S_ShiftReg;

architecture rtl of integrated_gcn_approx_fifo_w8_d32_S_ShiftReg is
