...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_approx_spmm_compute_acc_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_approx_spmm_compute_h_buf_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { row_fifo_dout { I 32 vector } row_fifo_empty_n { I 1 bit } row_fifo_read { O 1 bit } row_fifo_num_data_valid { I 5 vector } row_fifo_fifo_cap { I 5 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { col_fifo_dout { I 32 vector } col_fifo_empty_n { I 1 bit } col_fifo_read { O 1 bit } col_fifo_num_data_valid { I 9 vector } col_fifo_fifo_cap { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { val_fifo_dout { I 8 vector } val_fifo_empty_n { I 1 bit } val_fifo_read { O 1 bit } val_fifo_num_data_valid { I 9 vector } val_fifo_fifo_cap { I 9 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { result_fifo_din { O 8 vector } result_fifo_full_n { I 1 bit } result_fifo_write { O 1 bit } result_fifo_num_data_valid { I 32 vector } result_fifo_fifo_cap { I 32 vector } } \
} "
}
