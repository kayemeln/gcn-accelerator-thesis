...
set C_modelArgList {
	...
	{ result_fifo int 8 regular {fifo 0 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem6", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "H_out","offset": { "type": "dynamic","port_name": "H_out","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	...
 	{ "Name" : "result_fifo", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ result_fifo_dout sc_in sc_lv 8 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_fifo_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "result_fifo", "role": "dout" }} , 
...
set Spec2ImplPortList { 
	...
	result_fifo { ap_fifo {  { result_fifo_dout fifo_data_out 0 8 }  { result_fifo_empty_n fifo_status_empty 0 1 }  { result_fifo_read fifo_data_in 1 1 }  { result_fifo_num_data_valid fifo_update 0 6 }  { result_fifo_fifo_cap fifo_data 0 6 } } }
}
