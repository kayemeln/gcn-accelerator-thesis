...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { result_fifo_dout { I 8 vector } result_fifo_empty_n { I 1 bit } result_fifo_read { O 1 bit } result_fifo_num_data_valid { I 6 vector } result_fifo_fifo_cap { I 6 vector } } \
} "
}
