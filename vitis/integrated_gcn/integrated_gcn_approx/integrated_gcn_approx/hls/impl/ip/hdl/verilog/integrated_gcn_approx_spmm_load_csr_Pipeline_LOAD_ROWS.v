...
module integrated_gcn_approx_spmm_load_csr_Pipeline_LOAD_ROWS (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] gmem3_addr_read_reg_129;
reg   [11:0] i_fu_56;
wire   [11:0] add_ln202_fu_96_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln202_fu_90_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln202_fu_90_p2 == 1'd1))) begin
...
assign add_ln202_fu_96_p2 = (ap_sig_allocacmp_i_1 + 12'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001_grp1 = (((row_fifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem3_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((row_fifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem3_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_grp1 = (((row_fifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem3_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end

assign ap_block_pp0_stage0_grp1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((row_fifo_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)) | ((m_axi_gmem3_0_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1)));
end
...
assign icmp_ln202_fu_90_p2 = ((ap_sig_allocacmp_i_1 == 12'd2708) ? 1'b1 : 1'b0);
...
assign row_fifo_din = gmem3_addr_read_reg_129;

endmodule //integrated_gcn_approx_spmm_load_csr_Pipeline_LOAD_ROWS
