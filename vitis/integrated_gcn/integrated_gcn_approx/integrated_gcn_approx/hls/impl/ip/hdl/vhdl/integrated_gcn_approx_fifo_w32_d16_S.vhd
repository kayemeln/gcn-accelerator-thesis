...
entity integrated_gcn_approx_fifo_w32_d16_S is 
    generic (
...
architecture rtl of integrated_gcn_approx_fifo_w32_d16_S is
...
------------------------Component----------------------
    component integrated_gcn_approx_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
...
begin
----------------------- Instantiation -----------------------
    U_integrated_gcn_approx_fifo_w32_d16_S_ShiftReg : integrated_gcn_approx_fifo_w32_d16_S_ShiftReg
    generic map (
...
entity integrated_gcn_approx_fifo_w32_d16_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 16);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end integrated_gcn_approx_fifo_w32_d16_S_ShiftReg;

architecture rtl of integrated_gcn_approx_fifo_w32_d16_S_ShiftReg is
