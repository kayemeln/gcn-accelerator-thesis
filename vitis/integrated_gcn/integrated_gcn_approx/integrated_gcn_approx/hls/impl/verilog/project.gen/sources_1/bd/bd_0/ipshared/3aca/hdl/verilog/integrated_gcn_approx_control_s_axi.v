...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module integrated_gcn_approx_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_W_DATA_1          = 7'h20,
    ADDR_W_CTRL            = 7'h24,
    ADDR_H_TEMP_DATA_0     = 7'h28,
    ADDR_H_TEMP_DATA_1     = 7'h2c,
    ADDR_H_TEMP_CTRL       = 7'h30,
    ADDR_ROW_LENGTH_DATA_0 = 7'h34,
    ADDR_ROW_LENGTH_DATA_1 = 7'h38,
    ADDR_ROW_LENGTH_CTRL   = 7'h3c,
    ADDR_COLIND_DATA_0     = 7'h40,
    ADDR_COLIND_DATA_1     = 7'h44,
    ADDR_COLIND_CTRL       = 7'h48,
    ADDR_VALUES_DATA_0     = 7'h4c,
    ADDR_VALUES_DATA_1     = 7'h50,
    ADDR_VALUES_CTRL       = 7'h54,
    ADDR_H_OUT_DATA_0      = 7'h58,
    ADDR_H_OUT_DATA_1      = 7'h5c,
    ADDR_H_OUT_CTRL        = 7'h60,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
