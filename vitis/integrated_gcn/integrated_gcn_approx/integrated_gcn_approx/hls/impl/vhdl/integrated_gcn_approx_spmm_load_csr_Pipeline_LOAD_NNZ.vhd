...
entity integrated_gcn_approx_spmm_load_csr_Pipeline_LOAD_NNZ is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of integrated_gcn_approx_spmm_load_csr_Pipeline_LOAD_NNZ is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln208_fu_130_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem4_addr_read_reg_180 : STD_LOGIC_VECTOR (31 downto 0);
    signal gmem5_addr_read_reg_185 : STD_LOGIC_VECTOR (7 downto 0);
    signal i_1_fu_68 : STD_LOGIC_VECTOR (30 downto 0) := "0000000000000000000000000000000";
    signal add_ln208_fu_136_p2 : STD_LOGIC_VECTOR (30 downto 0);
    ...
    signal zext_ln208_fu_126_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln208_fu_130_p2 = ap_const_lv1_1))) then 
    ...
    add_ln208_fu_136_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1_load) + unsigned(ap_const_lv31_1));
    ...
    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln208_fu_130_p2)
    begin
        if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln208_fu_130_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone))) then 
    ...
    ap_sig_allocacmp_i_1_load_assign_proc : process(ap_CS_fsm_pp0_stage0, i_1_fu_68, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    col_fifo_din <= gmem4_addr_read_reg_180;
    ...
    icmp_ln208_fu_130_p2 <= "1" when (signed(zext_ln208_fu_126_p1) < signed(nnz_total)) else "0";
    ...
    val_fifo_din <= gmem5_addr_read_reg_185;
    ...
    zext_ln208_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_1_load),32));
end behav;
