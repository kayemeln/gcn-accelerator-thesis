...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "X","offset": { "type": "dynamic","port_name": "X","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "X_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ X_stream_din sc_out sc_lv 512 signal 2 } 
	{ X_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ X_stream_write sc_out sc_logic 1 signal 2 } 
	{ X_stream_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ X_stream_fifo_cap sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "X_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "X_stream", "role": "din" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "126606", "Max" : "126606"}
...
set Spec2ImplPortList { 
	...
	X { ap_stable {  { X in_data 0 64 } } }
	X_stream { ap_fifo {  { X_stream_din fifo_data_out 1 512 }  { X_stream_full_n fifo_status_empty 0 1 }  { X_stream_write fifo_data_in 1 1 }  { X_stream_num_data_valid fifo_update 0 5 }  { X_stream_fifo_cap fifo_data 0 5 } } }
}
