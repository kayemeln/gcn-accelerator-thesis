...
set name integrated_gcn_mul_5ns_14ns_17_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_mac_muladd_7ns_7ns_17s_17_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { X_stream_din { O 512 vector } X_stream_full_n { I 1 bit } X_stream_write { O 1 bit } X_stream_num_data_valid { I 5 vector } X_stream_fifo_cap { I 5 vector } } \
} "
}
...
set InstName integrated_gcn_flow_control_loop_pipe_U
set CompName integrated_gcn_flow_control_loop_pipe
