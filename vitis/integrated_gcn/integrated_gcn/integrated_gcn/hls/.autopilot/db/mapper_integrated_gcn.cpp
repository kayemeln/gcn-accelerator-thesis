...
extern "C" void integrated_gcn(Byte<64>*, Byte<64>*, Byte<64>*, Byte<4>*, Byte<4>*, Byte<2>*, Byte<64>*, int, int, int, int, int, int, int, int);
extern "C" void apatb_integrated_gcn_hw(volatile void * __xlx_apatb_param_X, volatile void * __xlx_apatb_param_W, volatile void * __xlx_apatb_param_H_temp, volatile void * __xlx_apatb_param_row_length, volatile void * __xlx_apatb_param_colind, volatile void * __xlx_apatb_param_values, int __xlx_apatb_param_nnz_total, volatile void * __xlx_apatb_param_H_out) {
