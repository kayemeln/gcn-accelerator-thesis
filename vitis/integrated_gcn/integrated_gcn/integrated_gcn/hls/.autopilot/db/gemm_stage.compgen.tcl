...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_fifo_w512_d16_A BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {X_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_fifo_w512_d16_A BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {W_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_fifo_w512_d16_A BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {XW_stream_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_start_for_gemm_compute_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_gemm_compute_U0_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_start_for_gemm_write_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_gemm_write_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_W \
    op interface \
    ports { W { I 64 vector } W_ap_vld { I 1 bit } } \
} "
}
