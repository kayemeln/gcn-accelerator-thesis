...
set C_modelArgMapList {[ 
	{ "Name" : "gmem1", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "W","offset": { "type": "dynamic","port_name": "W","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "W_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ W_stream_din sc_out sc_lv 512 signal 2 } 
	{ W_stream_full_n sc_in sc_logic 1 signal 2 } 
	{ W_stream_write sc_out sc_logic 1 signal 2 } 
	{ W_stream_num_data_valid sc_in sc_lv 5 signal 2 } 
	{ W_stream_fifo_cap sc_in sc_lv 5 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "W_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "W_stream", "role": "din" }} , 
 	{ "name": "W_stream_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "W_stream", "role": "full_n" }} , 
 	{ "name": "W_stream_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "W_stream", "role": "write" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "126603", "Max" : "126603"}
	, {"Name" : "Interval", "Min" : "126593", "Max" : "126593"}
]}
...
set Spec2ImplPortList { 
	...
	W { ap_stable {  { W in_data 0 64 } } }
	W_stream { ap_fifo {  { W_stream_din fifo_data_out 1 512 }  { W_stream_full_n fifo_status_empty 0 1 }  { W_stream_write fifo_data_in 1 1 }  { W_stream_num_data_valid fifo_update 0 5 }  { W_stream_fifo_cap fifo_data 0 5 } } }
}
