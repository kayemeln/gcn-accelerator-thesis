...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_spmm_compute_acc_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler integrated_gcn_spmm_compute_h_buf_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { val_fifo_dout { I 16 vector } val_fifo_empty_n { I 1 bit } val_fifo_read { O 1 bit } val_fifo_num_data_valid { I 9 vector } val_fifo_fifo_cap { I 9 vector } } \
} "
}
