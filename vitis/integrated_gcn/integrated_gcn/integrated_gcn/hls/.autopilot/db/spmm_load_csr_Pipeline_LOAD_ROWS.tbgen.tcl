...
set C_modelArgList {
	...
	{ sext_ln210 int 62 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem3", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "row_length","offset": { "type": "dynamic","port_name": "row_length","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "sext_ln210", "interface" : "wire", "bitwidth" : 62, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ sext_ln210 sc_in sc_lv 62 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln210", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "sext_ln210", "role": "default" }}  ]}
...
set Spec2ImplPortList { 
	...
	sext_ln210 { ap_stable {  { sext_ln210 in_data 0 62 } } }
