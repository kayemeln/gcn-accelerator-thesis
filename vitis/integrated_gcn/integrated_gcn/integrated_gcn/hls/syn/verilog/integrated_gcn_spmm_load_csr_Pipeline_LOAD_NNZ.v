...
module integrated_gcn_spmm_load_csr_Pipeline_LOAD_NNZ (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] gmem4_addr_read_reg_186;
reg   [15:0] gmem5_addr_read_reg_191;
reg   [30:0] i_2_fu_70;
wire   [30:0] add_ln216_fu_142_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_2_load;
wire    ap_block_pp0_stage0;
reg    ap_block_pp0_stage0_01001_grp1;
reg    ap_block_pp0_stage0_01001_grp2;
wire   [31:0] zext_ln216_fu_132_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln216_fu_136_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln216_fu_136_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
assign add_ln216_fu_142_p2 = (ap_sig_allocacmp_i_2_load + 31'd1);
...
assign col_fifo_din = gmem4_addr_read_reg_186;

assign icmp_ln216_fu_136_p2 = (($signed(zext_ln216_fu_132_p1) < $signed(nnz_total)) ? 1'b1 : 1'b0);
...
assign val_fifo_din = gmem5_addr_read_reg_191;

assign zext_ln216_fu_132_p1 = ap_sig_allocacmp_i_2_load;

endmodule //integrated_gcn_spmm_load_csr_Pipeline_LOAD_NNZ
