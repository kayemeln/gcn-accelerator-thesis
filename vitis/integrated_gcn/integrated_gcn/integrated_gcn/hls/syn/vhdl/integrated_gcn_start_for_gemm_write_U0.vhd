...
entity integrated_gcn_start_for_gemm_write_U0 is 
    generic (
...
architecture rtl of integrated_gcn_start_for_gemm_write_U0 is
...
------------------------Component----------------------
    component integrated_gcn_start_for_gemm_write_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_integrated_gcn_start_for_gemm_write_U0_ShiftReg : integrated_gcn_start_for_gemm_write_U0_ShiftReg
    generic map (
...
entity integrated_gcn_start_for_gemm_write_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end integrated_gcn_start_for_gemm_write_U0_ShiftReg;

architecture rtl of integrated_gcn_start_for_gemm_write_U0_ShiftReg is
