...
entity integrated_gcn_spmm_load_csr_Pipeline_LOAD_ROWS is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of integrated_gcn_spmm_load_csr_Pipeline_LOAD_ROWS is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln210_fu_90_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal gmem3_addr_read_reg_129 : STD_LOGIC_VECTOR (31 downto 0);
    signal i_fu_56 : STD_LOGIC_VECTOR (11 downto 0) := "000000000000";
    signal add_ln210_fu_96_p2 : STD_LOGIC_VECTOR (11 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln210_fu_90_p2 = ap_const_lv1_0))) then 
                    i_fu_56 <= add_ln210_fu_96_p2;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                gmem3_addr_read_reg_129 <= m_axi_gmem3_0_RDATA;
            end if;
        end if;
    end process;
    ...
    add_ln210_fu_96_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_1) + unsigned(ap_const_lv12_1));
    ap_CS_fsm_pp0_stage0 <= ap_CS_fsm(0);
        ap_block_pp0_stage0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_01001_grp1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_gmem3_0_RVALID, row_fifo_full_n)
    begin
                ap_block_pp0_stage0_01001_grp1 <= (((row_fifo_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((m_axi_gmem3_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_gmem3_0_RVALID, row_fifo_full_n)
    begin
                ap_block_pp0_stage0_11001 <= (((row_fifo_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((m_axi_gmem3_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_block_pp0_stage0_11001_grp1_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_gmem3_0_RVALID, row_fifo_full_n)
    begin
                ap_block_pp0_stage0_11001_grp1 <= (((row_fifo_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((m_axi_gmem3_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;

        ap_block_pp0_stage0_grp1 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_block_pp0_stage0_subdone_assign_proc : process(ap_enable_reg_pp0_iter1, ap_enable_reg_pp0_iter2, m_axi_gmem3_0_RVALID, row_fifo_full_n)
    begin
                ap_block_pp0_stage0_subdone <= (((row_fifo_full_n = ap_const_logic_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1)) or ((m_axi_gmem3_0_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1)));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln210_fu_90_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln210_fu_90_p2 = ap_const_lv1_1))) then 
    ...
    ap_sig_allocacmp_i_1_assign_proc : process(ap_CS_fsm_pp0_stage0, i_fu_56, ap_loop_init, ap_block_pp0_stage0)
    begin
    ...
    icmp_ln210_fu_90_p2 <= "1" when (ap_sig_allocacmp_i_1 = ap_const_lv12_A94) else "0";
    ...
    row_fifo_blk_n_assign_proc : process(ap_enable_reg_pp0_iter2, row_fifo_full_n, ap_block_pp0_stage0_grp1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_grp1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            row_fifo_blk_n <= row_fifo_full_n;
        else 
            row_fifo_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    row_fifo_din <= gmem3_addr_read_reg_129;

    row_fifo_write_assign_proc : process(ap_enable_reg_pp0_iter2, ap_block_pp0_stage0_11001_grp1)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_grp1) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1))) then 
            row_fifo_write <= ap_const_logic_1;
        else 
            row_fifo_write <= ap_const_logic_0;
        end if; 
    end process;
