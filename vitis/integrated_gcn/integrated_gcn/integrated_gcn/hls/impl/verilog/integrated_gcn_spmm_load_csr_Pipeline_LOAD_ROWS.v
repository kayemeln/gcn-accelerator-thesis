...
module integrated_gcn_spmm_load_csr_Pipeline_LOAD_ROWS (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln210_fu_90_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln210_fu_90_p2 == 1'd1))) begin
...
assign add_ln210_fu_96_p2 = (ap_sig_allocacmp_i_1 + 12'd1);
...
assign icmp_ln210_fu_90_p2 = ((ap_sig_allocacmp_i_1 == 12'd2708) ? 1'b1 : 1'b0);
...
endmodule //integrated_gcn_spmm_load_csr_Pipeline_LOAD_ROWS
