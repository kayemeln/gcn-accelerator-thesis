...
#define XINTEGRATED_GCN_CONTROL_ADDR_X_DATA          0x10
#define XINTEGRATED_GCN_CONTROL_BITS_X_DATA          64
#define XINTEGRATED_GCN_CONTROL_ADDR_W_DATA          0x1c
#define XINTEGRATED_GCN_CONTROL_BITS_W_DATA          64
#define XINTEGRATED_GCN_CONTROL_ADDR_H_TEMP_DATA     0x28
#define XINTEGRATED_GCN_CONTROL_BITS_H_TEMP_DATA     64
#define XINTEGRATED_GCN_CONTROL_ADDR_ROW_LENGTH_DATA 0x34
#define XINTEGRATED_GCN_CONTROL_BITS_ROW_LENGTH_DATA 64
#define XINTEGRATED_GCN_CONTROL_ADDR_COLIND_DATA     0x40
#define XINTEGRATED_GCN_CONTROL_BITS_COLIND_DATA     64
#define XINTEGRATED_GCN_CONTROL_ADDR_VALUES_DATA     0x4c
#define XINTEGRATED_GCN_CONTROL_BITS_VALUES_DATA     64
#define XINTEGRATED_GCN_CONTROL_ADDR_H_OUT_DATA      0x58
#define XINTEGRATED_GCN_CONTROL_BITS_H_OUT_DATA      64
