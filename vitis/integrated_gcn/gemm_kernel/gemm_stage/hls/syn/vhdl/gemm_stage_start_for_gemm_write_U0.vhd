...
entity gemm_stage_start_for_gemm_write_U0 is 
    generic (
...
architecture rtl of gemm_stage_start_for_gemm_write_U0 is
...
------------------------Component----------------------
    component gemm_stage_start_for_gemm_write_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_gemm_stage_start_for_gemm_write_U0_ShiftReg : gemm_stage_start_for_gemm_write_U0_ShiftReg
    generic map (
...
entity gemm_stage_start_for_gemm_write_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end gemm_stage_start_for_gemm_write_U0_ShiftReg;

architecture rtl of gemm_stage_start_for_gemm_write_U0_ShiftReg is
