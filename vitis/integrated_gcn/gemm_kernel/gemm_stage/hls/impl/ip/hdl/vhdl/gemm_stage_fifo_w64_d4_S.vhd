...
entity gemm_stage_fifo_w64_d4_S is 
    generic (
...
architecture rtl of gemm_stage_fifo_w64_d4_S is
...
------------------------Component----------------------
    component gemm_stage_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_gemm_stage_fifo_w64_d4_S_ShiftReg : gemm_stage_fifo_w64_d4_S_ShiftReg
    generic map (
...
entity gemm_stage_fifo_w64_d4_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end gemm_stage_fifo_w64_d4_S_ShiftReg;

architecture rtl of gemm_stage_fifo_w64_d4_S_ShiftReg is
