...
set name gemm_stage_mul_5ns_14ns_17_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler gemm_stage_mac_muladd_7ns_7ns_17s_17_1_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 0
}
...
set InstName gemm_stage_flow_control_loop_delay_pipe_U
set CompName gemm_stage_flow_control_loop_delay_pipe
