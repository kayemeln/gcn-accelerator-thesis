...
set cdfgNum 12
set C_modelName {gemm_write}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ XW_stream int 512 regular {fifo 0 volatile }  }
	{ gmem2 int 512 regular {axi_master 1}  }
	{ H_temp int 64 regular {fifo 0}  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "XW_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "READONLY"} , 
 	{ "Name" : "gmem2", "interface" : "axi_master", "bitwidth" : 512, "direction" : "WRITEONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "H_temp","offset": { "type": "dynamic","port_name": "H_temp","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "H_temp", "interface" : "fifo", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ H_temp_dout sc_in sc_lv 64 signal 2 } 
	{ H_temp_empty_n sc_in sc_logic 1 signal 2 } 
	{ H_temp_read sc_out sc_logic 1 signal 2 } 
	{ H_temp_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ H_temp_fifo_cap sc_in sc_lv 3 signal 2 } 
	...
	{ m_axi_gmem2_0_WDATA sc_out sc_lv 512 signal 1 } 
	{ m_axi_gmem2_0_WSTRB sc_out sc_lv 64 signal 1 } 
	...
	{ m_axi_gmem2_0_RDATA sc_in sc_lv 512 signal 1 } 
	{ m_axi_gmem2_0_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_gmem2_0_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_gmem2_0_RFIFONUM sc_in sc_lv 9 signal 1 } 
	...
	{ XW_stream_dout sc_in sc_lv 512 signal 0 } 
	{ XW_stream_empty_n sc_in sc_logic 1 signal 0 } 
	{ XW_stream_read sc_out sc_logic 1 signal 0 } 
	{ XW_stream_num_data_valid sc_in sc_lv 5 signal 0 } 
	{ XW_stream_fifo_cap sc_in sc_lv 5 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "H_temp_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "H_temp", "role": "dout" }} , 
 	{ "name": "H_temp_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "H_temp", "role": "empty_n" }} , 
 	{ "name": "H_temp_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "H_temp", "role": "read" }} , 
 	{ "name": "H_temp_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "H_temp", "role": "num_data_valid" }} , 
 	{ "name": "H_temp_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "H_temp", "role": "fifo_cap" }} , 
 	...
 	{ "name": "XW_stream_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "XW_stream", "role": "dout" }} , 
 	{ "name": "XW_stream_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "XW_stream", "role": "empty_n" }} , 
 	{ "name": "XW_stream_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "XW_stream", "role": "read" }} , 
 	{ "name": "XW_stream_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "XW_stream", "role": "num_data_valid" }} , 
 	{ "name": "XW_stream_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "XW_stream", "role": "fifo_cap" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "5514", "Max" : "5514"}
	, {"Name" : "Interval", "Min" : "5504", "Max" : "5504"}
]}
...
set Spec2ImplPortList { 
	XW_stream { ap_fifo {  { XW_stream_dout fifo_data_out 0 512 }  { XW_stream_empty_n fifo_status_empty 0 1 }  { XW_stream_read fifo_data_in 1 1 }  { XW_stream_num_data_valid fifo_update 0 5 }  { XW_stream_fifo_cap fifo_data 0 5 } } }
	...
	H_temp { ap_fifo {  { H_temp_dout fifo_data_out 0 64 }  { H_temp_empty_n fifo_status_empty 0 1 }  { H_temp_read fifo_data_in 1 1 }  { H_temp_num_data_valid fifo_update 0 3 }  { H_temp_fifo_cap fifo_data 0 3 } } }
}
