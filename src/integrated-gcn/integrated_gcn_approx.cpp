...
//
// All multiplications in the MAC kernels use gate-level approximate
// multipliers from EvoApproxLib, selected via APPROX_MUL_VARIANT.
...
static constexpr int GEMM_X_VECS_PER_K  = MI / DSIZE;          // 1 (was 2 with 16-bit)
static constexpr int GEMM_W_VECS_PER_K  = MJ / DSIZE;          // 1 (was 2 with 16-bit)
static constexpr int GEMM_XW_VECS_PER_ROW = MJ / DSIZE;        // 1 (was 2 with 16-bit)
...
// Comp: consume X/W streams, accumulate using approximate multiplier,
// stream result block out.
...
#pragma HLS UNROLL
                    ...
                    // Pipelined over i_outer; each cycle issues UI*MJ approx MACs.
                    COMP_I:
...
// ================================================================
//  STAGE 2: SpMM  (sparse matrix * dense, using approximate multiply)
// ================================================================
...
// ================================================================
//  TOP-LEVEL: GCN Layer (approximate)  --  A * (X * W)
// ================================================================
